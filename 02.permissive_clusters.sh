...
mkdir -p OUTPUT/permissive/tmp

mmseqs easy-linclust INPUT/permissive/clu_perm_mmseqs_input.faa OUTPUT/permissive/tmp/clu OUTPUT/permissive/tmp/clu_tmp --threads ${THREADS} -e 0.001 --min-seq-id 0.3 -c 0.3 --cov-mode 0 --spaced-kmer-mode 0 --remove-tmp-files 1
